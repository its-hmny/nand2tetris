// ! Forked from typescript-go repository: https://github.com/microsoft/typescript-go/blob/main/internal/collections/ordered_map.go
...
func NewOrderedMapFromMap[K comparable, V any](items map[K]V) OrderedMap[K, V] {
	mp := OrderedMap[K, V]{}
